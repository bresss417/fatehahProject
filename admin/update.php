<?php
    ...
    session_start();
    $p_id = $_GET['p_id'];
    $up = mysqli_query($conn,"SELECT * FROM product WHERE p_id='$p_id'");
    $assoc = mysqli_fetch_array($up, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="frame">
                    <div class="form-content">
                        ...
                        <div class="login-form">
                            <form action="chk_update.php" method="POST" enctype="multipart/form-data" class="form">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    ...
                                    <div class="mb-2">
                                        <img src="../images/<?php echo $assoc['p_photo']; ?>" alt="" id="preview_image" class="img-fluid">
                                    </div>
                                ...
                                <div class="form-group">
			                        <input type="text" name="p_name" class="form-control input-sm" value="<?php echo $assoc['p_name']; ?>">
                                </div>
                                <div class="form-group">
			                        <input type="text" name="p_detail" class="form-control input-sm" value="<?php echo $assoc['p_detail']; ?>">
                                </div>
                                <div class="row">
                                  <div class="col-md-3" style="">
                                    <div class="form-group">
			                           <input type="number" name="price" class="form-control input-sm" value="<?php echo $assoc['price']; ?>">
                                    </div>
                                  </div>
                                  <div class="col-md-2">                  
			                           <p class="mt-4">บาท</p>
                                  ...
                                  <div class="col-md-5">
                                   <select class="browser-default custom-select custom-select-sm mb-2 mt-3" name="cetegoty">
                                    <option selected><?php echo $assoc['p_cetegory']; ?></option>
